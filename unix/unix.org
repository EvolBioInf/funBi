...
The command-line interface is used on a daily basis by computer professionals
...
or edit text files. For this we need a specialized program, an
...
In order to find out, activate the \ty{emacs} menu by pressing
F10. Can you find out how to save your text?
