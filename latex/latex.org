...
shall use. Here we show you how to create a simple tex file and make
simple plots.
...
we add an histogram with 6 bins of the data we just
generated. Figure~\ref{fig:data} shows our first histogram. Since we
are plotting random numbers, yours is bound to look different.
\begin{figure}[h]
  \begin{center}
    \input{../latex/tikz_2}
  \end{center}
  \caption{Our first histogram plot showing the results of 100 dice rolls
